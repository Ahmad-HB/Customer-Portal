...
namespace Customer.Portal.Migrations
{
    ...
    [Migration("20250821203132_Fix_EmailTemplate_Fix_ReportTemplate")]
    partial class Fix_EmailTemplate_Fix_ReportTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Customer.Portal.Entities.AppUser", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Customer.Portal.Entities.Email", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Customer.Portal.Entities.EmailTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Customer.Portal.Entities.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Customer.Portal.Entities.ReportTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Customer.Portal.Entities.ServicePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Customer.Portal.Entities.UserServicePlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("UserServicePlans", (string)null);
                });
            ...
            modelBuilder.Entity("Customer.Portal.Entities.AppUser", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", "IdentityUser")
                        .WithOne()
                        .HasForeignKey("Customer.Portal.Entities.AppUser", "IdentityUserId")
            ...
            modelBuilder.Entity("Customer.Portal.Entities.Email", b =>
                {
                    b.HasOne("Customer.Portal.Entities.EmailTemplate", "EmailTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("Customer.Portal.Entities.Report", b =>
                {
                    b.HasOne("Customer.Portal.Entities.ReportTemplate", "ReportTemplate")
                        .WithMany()
            ...
            modelBuilder.Entity("Customer.Portal.Entities.SupportTicket", b =>
                {
                    b.HasOne("Customer.Portal.Entities.AppUser", "AppUser")
                        .WithMany("SupportTickets")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Customer.Portal.Entities.ServicePlan", "ServicePlan")
                        .WithMany()
                        .HasForeignKey("ServicePlanId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Volo.Abp.Identity.IdentityUser", "Supportagent")
                        .WithMany()
                        .HasForeignKey("SupportagentId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Volo.Abp.Identity.IdentityUser", "Technician")
                        .WithMany()
